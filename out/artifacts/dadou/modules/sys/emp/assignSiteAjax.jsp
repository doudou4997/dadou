...
function getSiteIds(){
	 var rselect = document.getElementById("right_select_site");
	 //构造角色ids,分隔符为';'
	 var siteIds = "";
	 for(i = 0;i < rselect.length; i++){
	    ...
	    siteIds +=rselect.options[i].value;
	 }
    return siteIds;
}
//为用户分配多个工厂
function doAssignSite(){
var rselect = document.getElementById("right_select_site");
 //构造工厂ids,分隔符为';'
 var siteIds = "";
 for(i = 0;i < rselect.length; i++){
 ...
 $('#siteIds').attr('value',siteIds);
 //利用Ajax赋值
 var url = "${ctx}/emp/doAssignSite";
 $.ajax({
 	url:url,
									...
									<tr>
										<td colspan="3">
											<div align="left" style="height:20px;padding:3px; border-radius:5px; border:1px solid #ccc; background:#f2f2f2;">
												<b>为用户&nbsp;&nbsp;<span style="color:red;">${emp.userName }</span>&nbsp;&nbsp;分配工厂:</b>
											</div>
										</td>
									</tr>
								</table>
															...
															<table align='center' >
																<tr>
																	...
																	<td width='40%' align='center' bgcolor="#56d9ff;" height="20">
																		<span style="color:white">已分配工厂</span>
																	</td>
																</tr>
																<tr>
																	<td width='45%' align='center'>
																	    <form:select id="left_select_site" path="unAssignList" items="${unAssignList }" ondblclick="move('left_select_site','right_select_site');" itemLabel="name" itemValue="id" cssStyle="HEIGHT: 300px; WIDTH: 250px" multiple="true"/>
																	</td>
																	<td width='10%' align='center'>
																		<img name='btn_select_addany' id="btn_select_addany_site"
																			src='${ctx}/styles/images/arrowRight_clicked.gif'
																			onClick="moveSelected('left_select_site','right_select_site');">
																		<br>
																		<br>
																		<img name='btn_select_dltany' id="btn_select_dltany_site"
																			src='${ctx}/styles/images/arrowLeft_clicked.gif'
																			onClick="moveSelected('right_select_site','left_select_site');"">
																	</td>
																	<td width='45%' align='center'>
																	   <form:select id="right_select_site" path="assignedList"  items="${assignedList }" ondblclick="move('right_select_site','left_select_site');" itemLabel="name" itemValue="id" cssStyle="HEIGHT: 300px; WIDTH: 250px" multiple="true"/>
																	</td>
																</tr>
															</table>
														</div>
