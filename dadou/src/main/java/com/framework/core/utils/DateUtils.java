...
public final class DateUtils {
     ...
     * @return 用新日期格式表示的日期/时间字符串
     */
    public static String formatDate(String date,String patternFrom,String patternTo) {
     ...
     * @return
     * @author liuzhaofeng
     * Create DateTime: 2016年11月2日 下午10:16:29
     */
    public static int betweenMinutes(String beginTime,String endTime){
    	int minites=0;
    	String[] start=beginTime.split(":");
    	String[] end=endTime.split(":");
    	if(start.length==2 && end.length==2){
    		minites=Integer.parseInt(end[0])*60+Integer.parseInt(end[1]);
    		minites=minites-Integer.parseInt(start[0])*60-Integer.parseInt(start[1]);
    	}
    	return minites;
    }
}
