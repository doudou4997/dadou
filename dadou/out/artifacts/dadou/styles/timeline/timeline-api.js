...
(function() {
    ...
    var loadMe = function() {
        ...
        try {
            ...
            if (bundle) {
                ...
                includeJavascriptFiles(Timeline.urlPrefix, javascriptFiles);
                includeCssFiles(Timeline.urlPrefix, cssFiles);
            }
    ...
    if (typeof SimileAjax == "undefined") {
        ...
        var url = useLocalResources ?
        	config.ctx + "/styles/timeline/simile-ajax-api.js?bundle=false" :
