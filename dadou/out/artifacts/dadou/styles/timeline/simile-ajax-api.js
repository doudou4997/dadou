...
if (typeof SimileAjax == "undefined") {
    ...
    SimileAjax.includeJavascriptFiles = function(doc, urlPrefix, filenames) {
        ...
        SimileAjax.includeJavascriptFile(doc, SimileAjax.urlPrefix + "signal.js?" + filenames.length);
    };
    ...
    (function() {
        ...
        if (SimileAjax.params.bundle) {
        	...
        	// styles/
            SimileAjax.includeJavascriptFiles(document, SimileAjax.urlPrefix + "", javascriptFiles);
        }
        // styles/
