...
var formatHtmlByK = null; //add by motaimin 对外提供html格式化函数
...
//////////////////start//////////////////
//add by motaimin 定义format函数，外部使用
formatHtmlByK = _formatHtml;
/////////////////end/////////////////////
...
_extend(KUploadButton, {
	init : function(options) {
		...
		var html = [
			...
			'</span>',
			'<input accept="image/*" type="file" class="ke-upload-file" name="' + fieldName + '" tabindex="-1" />',
...
function _tabs(options) {
	...
	self.select = function(index) {
		...
		_each(liList, function(i, li) {
			li.unbind();
			/******************************************************
			 * 只显示“本地上传”TAB页（取消判断条件）
			 * 2013-5-27 modified wangshub begin
			 ******************************************************/
			/*if (i === index) {*/
			...
			/******************************************************
			 * 2013-5-27 modified wangshub end
			 ******************************************************/
		});
		if (afterSelect) {
...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
			...
			yesBtn : {
				...
				click : function(e) {
					...
					if (showLocal && showRemote && tabs && tabs.selectedIndex === 1 || !showRemote) {
						...
						/******************************************************
						 * 判断选择的文件是否为图片文件
						 * 2013-5-24 added wangshub begin
						 ******************************************************/
						//获取文件路径或文件名
						var fileName = uploadbutton.fileBox.val();
						//计算出点的位置
						...
						switch(extName){
							...
							case "ico":
								break;
							default:
								alert(self.lang('pleaseSelectImgFile'));
								return;
						}
						/******************************************************
						 * 2013-5-24 added wangshub end
						 ******************************************************/
						dialog.showLoading(self.lang('uploadLoading'));
						uploadbutton.submit();
						localUrlBox.val('');
		...
		if (showRemote && showLocal) {
			...
			/******************************************************
			 * 不显示“网络图片”TAB页
			 * 2013-5-27 removed wangshub begin
			 ******************************************************/
			/*tabs.add({
			...
			/******************************************************
			 * 2013-5-27 removed wangshub end
			 ******************************************************/
			tabs.add({
